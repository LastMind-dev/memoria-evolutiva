...
- **Antes de explorar arquitetura**, execute o comando `memoria ciclo iniciar` do bloco
  gerenciado desta plataforma; depois consulte `memoria contexto`.
...
- **Depois de mudar fontes/docs**, execute o `memoria ciclo atualizar` do bloco gerenciado;
  para algoritmo, modelo ou provedor, rode `memoria avaliar verificar`. Não remensure
  baseline para mascarar regressão. Terminando a sessão, siga `docs/runbooks/sessao.md`.
